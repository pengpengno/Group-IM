...
class TenantSchemaProvisionerIntegrationTest {
    ...
    void provisionsEmptyTenantSupportsRetryAndRejectsLegacyClone() throws Exception {
        ...
        TenantSchemaProvisioner provisioner = new TenantSchemaProvisioner(dataSource, validator, inspector, executor);
        ...
        assertTrue(tableExists(dataSource, "company_new", "wb_task"));
        ...
        assertEquals(CoreTenantBaselineContract.MANAGED_TARGET_VERSION, retry.currentVersion());
        ...
        BusinessException legacy = assertThrows(BusinessException.class, () -> provisioner.provision("legacy_clone"));
