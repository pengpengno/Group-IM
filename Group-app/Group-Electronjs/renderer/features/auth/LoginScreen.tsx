  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        // API returns flat structure: { userId, username, ... }
        // We cast to any here because result.data is typed as AuthData which expects nested user object
        ...
        // Force a re-render or check if App.tsx picks it up
