...
public final class Meeting {
  ...
  public interface MeetingInfoOrBuilder extends
     ...
     * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
     */
    Account.AccountInfo getMeetingAccounts(int index);
    /**
     * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
     */
     ...
     * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
     */
    Account.AccountInfoOrBuilder getMeetingAccountsOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Meeting.internal_static_com_github_meeting_common_connect_model_proto_MeetingInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Meeting.internal_static_com_github_meeting_common_connect_model_proto_MeetingInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Meeting.MeetingInfo.class, Meeting.MeetingInfo.Builder.class);
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<Account.AccountInfo> meetingAccounts_;
    /**
     * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
     */
    @java.lang.Override
    public java.util.List<Account.AccountInfo> getMeetingAccountsList() {
     ...
     */
    @java.lang.Override
    public Account.AccountInfo getMeetingAccounts(int index) {
     ...
     */
    @java.lang.Override
    public Account.AccountInfoOrBuilder getMeetingAccountsOrBuilder(
        int index) {
      return meetingAccounts_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Meeting.MeetingInfo)) {
        return super.equals(obj);
      }
      Meeting.MeetingInfo other = (Meeting.MeetingInfo) obj;
    ...
    public static Meeting.MeetingInfo parseFrom(
    ...
    public static Meeting.MeetingInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Meeting.MeetingInfo parseFrom(
    ...
    public static Meeting.MeetingInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Meeting.MeetingInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Meeting.MeetingInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Meeting.MeetingInfo prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public Meeting.MeetingInfo getDefaultInstanceForType() {
        return Meeting.MeetingInfo.getDefaultInstance();
      }

      @java.lang.Override
      public Meeting.MeetingInfo build() {
        Meeting.MeetingInfo result = buildPartial();
      ...
      @java.lang.Override
      public Meeting.MeetingInfo buildPartial() {
        Meeting.MeetingInfo result = new Meeting.MeetingInfo(this);
      ...
      private void buildPartialRepeatedFields(Meeting.MeetingInfo result) {
        if (meetingAccountsBuilder_ == null) {
      ...
      private void buildPartial0(Meeting.MeetingInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Meeting.MeetingInfo) {
          return mergeFrom((Meeting.MeetingInfo)other);
        } else {
      ...
      public Builder mergeFrom(Meeting.MeetingInfo other) {
        if (other == Meeting.MeetingInfo.getDefaultInstance()) return this;
      ...
      private void ensureMeetingAccountsIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          meetingAccounts_ = new java.util.ArrayList<Account.AccountInfo>(meetingAccounts_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          Account.AccountInfo, Account.AccountInfo.Builder, Account.AccountInfoOrBuilder> meetingAccountsBuilder_;
       ...
       * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
       */
      public Builder addMeetingAccounts(Account.AccountInfo value) {
        if (meetingAccountsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
       */
      public Account.AccountInfo.Builder getMeetingAccountsBuilder(
          int index) {
       ...
       * <code>repeated .com.github.meeting.common.connect.model.proto.AccountInfo meetingAccounts = 3;</code>
       */
      public Account.AccountInfo.Builder addMeetingAccountsBuilder() {
    ...
    private static final Meeting.MeetingInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Meeting.MeetingInfo();
    }

    public static Meeting.MeetingInfo getDefaultInstance() {
